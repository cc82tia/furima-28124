class Item < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :delivery_source_id, presence: true, numericality: { other_than: 0, message:"は--以外を選択して下さい"} 
    validates :days_of_ships_id,   presence: true, numericality: { other_than: 1, message:"は--以外を選択して下さい"} 
